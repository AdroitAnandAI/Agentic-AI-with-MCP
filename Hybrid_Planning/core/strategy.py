...
from modules.tools import filter_tools_by_hint, summarize_tools, load_prompt, get_similar_memory_queries
...
async def generate_plan(
    ...
    print("input = " + perception.user_input)
    print("memory_items = " + memory_items)
    # First check memory for similar queries
    similar_queries = get_similar_memory_queries(perception.user_input, memory_items)
    if similar_queries:
    ...
    # If no memory match, proceed with generating new plan
